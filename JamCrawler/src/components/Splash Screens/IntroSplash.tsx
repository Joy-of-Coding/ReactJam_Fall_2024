...
export default function IntroSplash({ setCurrentAppState }: Props) {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
            ...
            <img
                src={imgSource}
                alt="game intro art picture"
                className="picture"
            />

            <p className="text-xl mb-4 text-center max-w-md font-Helvetica Neue">
                Quest: Our Farmer, George /* Allow Player Name here */, can see
                the hoof prints leading down into the inky depths of the dungeon
                and knows that he has no choice but to follow. He is compelled
                to get his favorite milk cow, Bessie, back to her stall before
                dark. "Goll darn her," George mutters to himself as he stumbles
                forward into the ghastly crevasse of Stygian Darkness.
            </p>
